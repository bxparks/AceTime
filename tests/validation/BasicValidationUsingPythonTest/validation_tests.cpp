...
testF(TransitionTest, CET) {
  assertValid(&ace_time::zonedb::kValidationDataCET);
}
testF(TransitionTest, CST6CDT) {
  assertValid(&ace_time::zonedb::kValidationDataCST6CDT);
}
testF(TransitionTest, EET) {
  assertValid(&ace_time::zonedb::kValidationDataEET);
}
testF(TransitionTest, EST) {
  assertValid(&ace_time::zonedb::kValidationDataEST);
}
testF(TransitionTest, EST5EDT) {
  assertValid(&ace_time::zonedb::kValidationDataEST5EDT);
}
testF(TransitionTest, Etc_GMT) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT);
}
testF(TransitionTest, Etc_GMT_PLUS_1) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_1);
}
testF(TransitionTest, Etc_GMT_PLUS_10) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_10);
}
testF(TransitionTest, Etc_GMT_PLUS_11) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_11);
}
testF(TransitionTest, Etc_GMT_PLUS_12) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_12);
}
testF(TransitionTest, Etc_GMT_PLUS_2) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_2);
}
testF(TransitionTest, Etc_GMT_PLUS_3) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_3);
}
testF(TransitionTest, Etc_GMT_PLUS_4) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_4);
}
testF(TransitionTest, Etc_GMT_PLUS_5) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_5);
}
testF(TransitionTest, Etc_GMT_PLUS_6) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_6);
}
testF(TransitionTest, Etc_GMT_PLUS_7) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_7);
}
testF(TransitionTest, Etc_GMT_PLUS_8) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_8);
}
testF(TransitionTest, Etc_GMT_PLUS_9) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_PLUS_9);
}
testF(TransitionTest, Etc_GMT_1) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_1);
}
testF(TransitionTest, Etc_GMT_10) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_10);
}
testF(TransitionTest, Etc_GMT_11) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_11);
}
testF(TransitionTest, Etc_GMT_12) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_12);
}
testF(TransitionTest, Etc_GMT_13) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_13);
}
testF(TransitionTest, Etc_GMT_14) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_14);
}
testF(TransitionTest, Etc_GMT_2) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_2);
}
testF(TransitionTest, Etc_GMT_3) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_3);
}
testF(TransitionTest, Etc_GMT_4) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_4);
}
testF(TransitionTest, Etc_GMT_5) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_5);
}
testF(TransitionTest, Etc_GMT_6) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_6);
}
testF(TransitionTest, Etc_GMT_7) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_7);
}
testF(TransitionTest, Etc_GMT_8) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_8);
}
testF(TransitionTest, Etc_GMT_9) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_GMT_9);
}
testF(TransitionTest, Etc_UTC) {
  assertValid(&ace_time::zonedb::kValidationDataEtc_UTC);
}
...
testF(TransitionTest, HST) {
  assertValid(&ace_time::zonedb::kValidationDataHST);
}
...
testF(TransitionTest, MET) {
  assertValid(&ace_time::zonedb::kValidationDataMET);
}
testF(TransitionTest, MST) {
  assertValid(&ace_time::zonedb::kValidationDataMST);
}
testF(TransitionTest, MST7MDT) {
  assertValid(&ace_time::zonedb::kValidationDataMST7MDT);
}
testF(TransitionTest, PST8PDT) {
  assertValid(&ace_time::zonedb::kValidationDataPST8PDT);
}
...
testF(TransitionTest, WET) {
  assertValid(&ace_time::zonedb::kValidationDataWET);
}
