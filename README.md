...
* TZ Database zone files
    ...
    * `ace_time::zonedb` (231 timezones for `BasicZoneSpecifier`)
        * `zonedb::kZoneAfrica_Abidjan`
        * `zonedb::kZoneAfrica_Accra`
        * ...
        * `zonedb::kZonePacific_Wake`
        * `zonedb::kZonePacific_Wallis`
    * `ace_time::zonedbx` (348 timezones for `ExtendedZoneSpecifier`)
...
(`int32_t`). The maximum date that AceTime can handle is 2068-01-19T03:14:07Z
