...
different than the AVR library. Also, this file probably belongs in another
library, instead of AceTime.
*/

#ifndef ACE_TIME_EEPROM_MANAGER_H
#define ACE_TIME_EEPROM_MANAGER_H
