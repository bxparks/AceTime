...
// America/Caracas (non-integral UNTIL time '2:30')
...
// Asia/Colombo (non-integral UNTIL time '0:30')
// Asia/Gaza (non-integral UNTIL time '0:01')
// Asia/Hebron (rule 'Palestine' not found)
// Asia/Hong_Kong (rule 'HK' not found)
// Asia/Macau (rule 'Macau' not found)
// Asia/Pyongyang (non-integral UNTIL time '23:30')
// CET (no '/' in zone name)
