...
// Zones
const uint16_t kZoneRegistrySize = 237;
extern const basic::ZoneInfo* const kZoneRegistry[237];
...
// Link Entries
const uint16_t kLinkRegistrySize = 215;
extern const basic::LinkEntry kLinkRegistry[215];
