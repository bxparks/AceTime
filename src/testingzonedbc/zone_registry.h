...
#ifndef ACE_TIME_TESTINGZONEDBC_ZONE_REGISTRY_H
#define ACE_TIME_TESTINGZONEDBC_ZONE_REGISTRY_H
...
extern const complete::Info::ZoneInfo* const kZoneRegistry[15];

// Zones and Links
const uint16_t kZoneAndLinkRegistrySize = 16;
extern const complete::Info::ZoneInfo* const kZoneAndLinkRegistry[16];
