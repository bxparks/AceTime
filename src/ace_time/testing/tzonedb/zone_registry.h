...
// Zones
const uint16_t kZoneRegistrySize = 1;
extern const basic::ZoneInfo* const kZoneRegistry[1];

// Zones and Links
const uint16_t kZoneAndLinkRegistrySize = 2;
extern const basic::ZoneInfo* const kZoneAndLinkRegistry[2];
